...
func Mathabs(args ...interface{}) (jnigo.JObject, error) {
	...
	sigMap := map[string]string{"I":"(I)I", "J":"(J)J", "F":"(F)F", "D":"(D)D"}
...
func MathfloorDiv(args ...interface{}) (jnigo.JObject, error) {
	...
	sigMap := map[string]string{"JI":"(JI)J", "JJ":"(JJ)J", "II":"(II)I"}
...
func MathfloorMod(args ...interface{}) (jnigo.JObject, error) {
	...
	sigMap := map[string]string{"JJ":"(JJ)J", "II":"(II)I", "JI":"(JI)I"}
	return jvm.CallStaticFunction("java/lang/Math", "floorMod", sigMap[sigArgs], convertedArgs)
}

func Mathfma(args ...interface{}) (jnigo.JObject, error) {
	convertedArgs, err := jvm.ConvertAll(args)
	if err != nil {
		return nil, err
	}
	...
	sigMap := map[string]string{"DDD":"(DDD)D", "FFF":"(FFF)F"}
	return jvm.CallStaticFunction("java/lang/Math", "fma", sigMap[sigArgs], convertedArgs)
}
...
func MathgetExponent(args ...interface{}) (jnigo.JObject, error) {
	...
	sigMap := map[string]string{"D":"(D)I", "F":"(F)I"}
...
func Mathmax(args ...interface{}) (jnigo.JObject, error) {
	...
	sigMap := map[string]string{"II":"(II)I", "JJ":"(JJ)J", "FF":"(FF)F", "DD":"(DD)D"}
...
func Mathmin(args ...interface{}) (jnigo.JObject, error) {
	...
	sigMap := map[string]string{"DD":"(DD)D", "II":"(II)I", "JJ":"(JJ)J", "FF":"(FF)F"}
...
func MathmultiplyFull(args ...interface{}) (jnigo.JObject, error) {
	convertedArgs, err := jvm.ConvertAll(args)
	if err != nil {
		return nil, err
	}
	...
	sigMap := map[string]string{"II":"(II)J"}
	return jvm.CallStaticFunction("java/lang/Math", "multiplyFull", sigMap[sigArgs], convertedArgs)
}

func MathmultiplyHigh(args ...interface{}) (jnigo.JObject, error) {
	convertedArgs, err := jvm.ConvertAll(args)
	if err != nil {
		return nil, err
	}
	...
	sigMap := map[string]string{"JJ":"(JJ)J"}
	return jvm.CallStaticFunction("java/lang/Math", "multiplyHigh", sigMap[sigArgs], convertedArgs)
}
...
func Mathround(args ...interface{}) (jnigo.JObject, error) {
	...
	sigMap := map[string]string{"F":"(F)I", "D":"(D)J"}
